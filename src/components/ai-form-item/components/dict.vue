<template>
    <a-row align="end">
        <a-table style="flex: 1;" v-if="data?.length" :data="data" :columns="columns" size="mini" :show-header="false"
            :bordered="false" :pagination="false" :scrollbar="false" :draggable="{}" @change="handleChange">
            <template #drag>
                <div class="cell">
...
// 字段配置
const columns = [
    { title: 'Label', dataIndex: 'label', slotName: 'label', view_type: 'input', is_edit: true, is_list: true },
    { title: 'Value', dataIndex: 'value', slotName: 'value', view_type: 'input', is_edit: true, is_list: true },
    { title: 'drag', dataIndex: 'drag', slotName: 'drag', width: 40, view_type: 'input', is_list: true },
    { title: '操作', dataIndex: 'optional', slotName: 'optional', width: 40, fixed: 'right', is_list: true }
]
